      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-1 space-y-3">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xs p-2 space-y-1">
            <button
              type="button"
              className="w-full flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl font-bold text-xs bg-indigo-600 text-white shadow-2xs text-left cursor-pointer"
            >
            ...
            <form onSubmit={handleSave} className="p-5 sm:p-6 space-y-5 text-xs">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full rounded-xl border border-slate-200 px-3.5 py-2.5 pr-10 text-xs text-slate-900 bg-slate-50 outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/10 transition-all placeholder:text-slate-400"
                    />
                    <button
                      type="button"
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 max-w-lg space-y-2.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className={hasLower ? "text-emerald-700 font-semibold" : "text-slate-500"}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className={hasUpper ? "text-emerald-700 font-semibold" : "text-slate-500"}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className={hasNumberOrSymbol ? "text-emerald-700 font-semibold" : "text-slate-500"}>
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold shadow-2xs transition-all disabled:opacity-50 cursor-pointer"
                >
