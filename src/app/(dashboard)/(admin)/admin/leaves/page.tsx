        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-indigo-500 focus:bg-white text-slate-900 placeholder:text-slate-400"
            />
          </div>
        </div>
      </div>
                ...
                displayedLeaves.map((req) => {
                  ...
                  return (
                    <tr key={req.id} className="hover:bg-slate-50/60 transition-colors">
                      ...
                      {/* Leave Type */}
                      <td className="px-5 py-3.5">
                        <span className="text-[11px] px-2.5 py-0.5 rounded-md bg-slate-100 text-slate-800 border border-slate-200 font-semibold whitespace-nowrap">
                          {req.leaveType.name}
                        </span>
                      </td>
                        ...
                        <div className="flex items-center justify-center">
                          {isPendingAdmin ? (
                            <div className="flex flex-col items-center gap-1">
                              {isEscalated && (
                                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-purple-50 text-purple-700 border border-purple-200 mb-0.5">
